...
function onSubmit(e) {
    ...
    refs.btnLoadMore.classList.add("is-hidden");
    const searchPhotos1 = refs.input.value.trim();
    console.log(searchPhotos1);
    apiBase(searchPhotos1, page);
    refs.btnLoadMore.classList.remove("is-hidden");
//   refs.input.value = "";
}
function onLoadMoreClick(e) {
    const searchPhotos2 = refs.input.value.trim();
    page += 1;
...
async function apiBase(searchPhotos3, page1) {
    ...
    try {
        const response = await (0, _axiosDefault.default).get(BASE_URL, options);
        console.log(response);
        console.log(response.data);
        if (response.data.hits.length === 0) (0, _notiflixDefault.default).Notify.warning("Sorry, there are no images matching your search query. Please try again.");
...
},{"notiflix":"5z0Oc","axios":"jo6P5","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
